package com.canerkaya.professionalartbook;
...
public class ArtContentProvider extends ContentProvider {
    static final String PROVIDER_NAME="com.canerkaya.professionalartbook.ArtContentProvider";
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)){
            case ARTS:
                ...
                break;
            default:
                throw new IllegalArgumentException("Uri bulunamadı.");
        }
